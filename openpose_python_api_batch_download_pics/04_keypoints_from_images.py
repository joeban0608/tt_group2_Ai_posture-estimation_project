...
try:
    ...
    parser.add_argument("--image_dir", default=r"D:\tt_group_total_pics\0427\input_total", help="Process a directory of images. Read all standard formats (jpg, png, bmp, etc.).")
    ...
    # Process and display images(直接resize 會有骨架跟圖片對應不起的問題)
    ...
    # Process and display images 柏翰_等比例縮放圖片:
    # i = 1
    count = 0
    wrong_pic_fn_list = []
    for imagePath in imagePaths:
        ...
        try:
            ...
            # print("keypoint_np_x_y_score_str:", keypoint_np_x_y_score_str)
        ...
        base = r"D:\tt_group_total_pics\0427\out_total"
        if not os.path.exists(base):
            os.makedirs(base)
        # 將x,y的骨架依檔案名稱存承json檔
        fn = base + "/" + pic_fn + ".json"
